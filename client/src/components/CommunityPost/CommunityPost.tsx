            ...
            <CardContent className={styles['CommunityPost__contentContainer']}>
              <div className={styles['CommunityPost__header']}>
                <div className={styles['CommunityPost__headerLeft']}>
                  {isMarker ? (
                    <img
                      className={styles['CommunityPost__markerIcon']}
                      src={markerIcon}
                      alt="Marker Type"
                    />
                  ) : null}
                ...
                <div className={styles['CommunityPost__headerRight']}>
                  ...
                  <Avatar>{user.substring(0, 1).toUpperCase()}</Avatar>
                </div>
              </div>
              <div className={styles['CommunityPost__bodyPreview']}>
                {isMarker ? (
                  ...
                  //   <img
                  //     src={Logo}
                  //     className={styles['CommunityPost__markerBodyPreview']}
                  //     alt="Roadwatch Logo"
                  //   />
                  <StyledTypography
                    variant="body2"
                    color="text.secondary"
                    className={styles['CommunityPost__textBody']}
                  >
                    {body}
                  </StyledTypography>
                ) : (
              ...
              <div>
                <CustomButton onClick={viewPost}>View Post</CustomButton>
              </div>
            </CardContent>
          </div>
        </Card>
